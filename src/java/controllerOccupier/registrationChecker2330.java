 ...
 * @author INDIA
 */
@WebServlet(name = "registrationChecker2330", urlPatterns = {"/registrationChecker2330"})
public class registrationChecker2330 extends HttpServlet {
...
public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
    ...
    {
        response.sendRedirect("occupierregistration23-30.jsp");
    }
