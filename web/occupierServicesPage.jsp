<%-- 
    Document   : occupierServicesPage
    Created on : 24 Nov, 2023, 5:56:39 AM
    Author     : INDIA
--%>
                ...
                <div class="col-12 col-sm-5 col-md-4 n-auto"> 
                    <div class="card border-0 shadow"> 
                        <div class="card-body">
                            <form action="">
        <header>
            <a href="occupierProfile.jsp"><button type="button" class="btn btn-primary">Profile</button></a>
  </header>
    ...
    response.sendRedirect("gethome.jsp");
       ...
       <div class="container mt-5">
            ...
            {  %>
                      ...
                      <tr>
                          <td>
                              <form action="landlordProfileforOccupier.jsp" method="post">
