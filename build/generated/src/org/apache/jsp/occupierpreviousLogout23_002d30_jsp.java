...
import controllerOccupier.PreviousDeleteChecker2330;

public final class occupierpreviousLogout23_002d30_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <form id=\"deleteAccountForm\" action=\"PreviousDeleteChecker2330\"  method=\"post\">\n");
    ...
    response.sendRedirect("occupierlogin23-30.jsp");
            ...
            ResultSet rs = null;
                ...
                try {
                    ...
                    String query = "SELECT email_id FROM occupier23 WHERE password='"+password+"'";
      ...
      out.write("\n");
      out.write("    \n");
      out.write("                    <button><input type=\"submit\" value=\"Delete\" /></button>\n");
      out.write("    </form>\n");
      out.write("  </div>\n");
      out.write("</body>\n");
      out.write("</html>\n");
