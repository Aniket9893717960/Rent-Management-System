<%-- 
    Document   : ResetPassword18-22
    Created on : 8 Aug, 2023, 8:24:55 AM
    Author     : INDIA
--%>
...
<body>
    ...
    <h2>Set Password</h2>
      <br>
    <form action="resetPasswordChecker1823" method="post">
    ...
    <div class="message">Already have an account? <a href="occupierlogin18-22.jsp">Click Here For Login</a></div>
  </div>
</body>
</html>
